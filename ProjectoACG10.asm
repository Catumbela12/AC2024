; Grupo Nº 10
; INTEGRANTES:
; ERNESTO CATUMBELA ----  ANTONIO JAMBA ----  CONSTANTINO AFONSO  ----  RODRIGUES RAIMUNDO 
;-----------------------------------------------------------------------------------
BUFFER	EQU	200H	 ; endereço de mem ria onde se guarda a tecla
LINHA	EQU	8		;possui o do bit correspondente a linha (4) a testar
